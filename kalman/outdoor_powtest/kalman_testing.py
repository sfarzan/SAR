...
## these are the files pathes, first one is input, second output
...
####should not need to touch anything
...
csvProcess(OUTPUT_FILEPATH,processNoiseArray, measurementNoiseArray)
