...
from src.drone_communicator_HW import DroneCommunicator_HW
import math
...
# If in Simulation, will initialize connection between coordinator.py scripts directly via UDP. Otherwise, connection will be initialized via Pymavlink interface
if (params.sim_mode == True):
    drone_comms = DroneCommunicator(drone_config, params, drones)
elif (params.sim_mode == False):
    drone_comms = DroneCommunicator_HW(drone_config, params, drones)
